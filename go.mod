...
replace github.com/filecoin-project/sector-storage => ./extern-dev/sector-storage
// replace github.com/filecoin-project/storage-fsm => ./extern-dev/storage-fsm
replace github.com/filecoin-project/specs-storage => ./extern-dev/specs-storage
